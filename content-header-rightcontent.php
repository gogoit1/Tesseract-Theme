...
<div id="site-banner-right" class="banner-right <?php echo $headright_content; ?>">
	<?php
	if ($is_headright_content) {
		tesseract_header_right_content($headright_content);
	} else if ( ! $is_headright_content && $headright_content_default_button) {
	?>
  <div id="header-button-container">
	...
	if (is_plugin_active('woocommerce/woocommerce.php') && $wc_headercart) {
