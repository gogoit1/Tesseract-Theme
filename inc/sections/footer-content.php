...
$wp_customize->add_control(new Tesseract_Customize_Footer_Control(
		$wp_customize,
...
$tesseract_menu_selector_menus = get_terms('nav_menu');
	if ($tesseract_menu_selector_menus) :
		...
		$wp_customize->add_setting('tesseract_footer_menu_select', array('sanitize_callback' => 'tesseract_sanitize_select'
		));

		$wp_customize->add_control(new WP_Customize_Control(

				$wp_customize, 'tesseract_footer_menu_select_control',
				array(
		...
		$wp_customize->add_control(new Tesseract_Customize_Footer2_Control(
			$wp_customize,
